...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
		...
		<main class="app-main">
			...
			<div class="app-content-header">
				...
				<div class="container-fluid">
					...
					<div class="row mb-5">
						<div class="col-sm-6">
							<h3 class="mb-0">Mission-Solvs</h3>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-end">

								<li style="margin-right: 5px">
									<button type="button" class="btn btn-outline-dark">문제</button>
								</li>

								<li>
									<button type="button" class="btn btn-outline-dark">미션</button>
								</li>
							</ol>
						</div>
			...
			<div class="app-content">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="card mb-4">
								<div class="card-header"><h3 class="card-title">내가 제출한 답변</h3></div>
						...
						<div class="col-md-6">
							<div class="card mb-4" >
								<div class="card-header"><h3 class="card-title">AI 추천 코드</h3></div>
  ...
  <button class="btn btn-primary" type="button">내 실력 분석하기</button>
			</div>
		</main>
		<!--end::App Main-->
		<!--begin::Footer-->
